 ...
 * Enabling Lazy Deletion and Garbage Collection
...
implements Cloneable
{
   ...
   /**
    * call private method to collect garbage
    * @return true if successfully remove the nodes mark deleted
    */
   ...
   /**traverse the tree, find the nodes that are soft-deleted and
    * call removeHard to remove these nodes
